...
export default function BookSubmissionSuccessPage() {
  return (
        ...
        <CardContent className="p-8 text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-power100-grey text-lg leading-relaxed">
              Thank you for submitting your book to The Power100 Experience. 
            ...
            <div className="text-left space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-power100-grey">
                  <strong>Review Process:</strong> Our team will review your book submission to ensure it aligns with our contractor community's needs.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-power100-red rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p className="text-power100-grey">
                  <strong>Content Verification:</strong> We'll verify the book information and may request additional details if needed.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-power100-red rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p className="text-power100-grey">
                  <strong>Approval Notification:</strong> You'll receive an email notification once your book is approved for inclusion.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-power100-red rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p className="text-power100-grey">
                  <strong>Matching Integration:</strong> Approved books will be included in our AI matching system to connect with relevant contractors.
                </p>
              </div>
            </div>
          </div>

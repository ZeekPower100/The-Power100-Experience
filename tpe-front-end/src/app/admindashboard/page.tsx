      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <Link href="/admindashboard/routing-metrics">
              <Card className="bg-white hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-power100-red">
                <CardContent className="p-6 text-center">
            ...
            <Link href="/admindashboard/ige-monitor">
              <Card className="bg-white hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-power100-red">
                <CardContent className="p-6 text-center">
                  <Target className="w-8 h-8 text-power100-red mx-auto mb-3" />
                  <h3 className="font-semibold text-power100-black">IGE Monitor</h3>
                  <p className="text-sm text-power100-grey mt-1">Phase 3 Internal Goal Engine monitoring</p>
                </CardContent>
              </Card>
            </Link>

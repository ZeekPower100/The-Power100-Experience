...
async function testPodcastAPIs() {
  try {
    ...
    const endpoints = [
      ...
      { name: 'Search Transcripts (fixed)', method: 'GET', url: `${API_BASE_URL}/podcast-episodes/search/transcripts?q=business` },
      ...
      { name: 'Process Episode (fixed)', method: 'POST', url: `${API_BASE_URL}/podcast-episodes/process`,
...
// Run the test
console.log('🚀 Testing Podcast API Endpoints in Production');
console.log('==============================================');

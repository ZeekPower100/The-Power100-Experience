...
// ================================================================
// PRODUCTION MIGRATION: Internal Goal Engine Tables
// ================================================================
...
async function query(sql, params = []) {
  return await productionClient.query(sql, params);
}

async function createInternalGoalEngineTablesProduction() {
  console.log('\n🚀 CREATING INTERNAL GOAL ENGINE TABLES - PRODUCTION');
  ...
  try {
    ...
    `);
    console.log(`\n✅ ai_concierge_goals: ${goalsColumnCount.rows[0].column_count} columns (expected 18)`);
    ...
    console.log('\n' + '='.repeat(80));
    console.log('✅ INTERNAL GOAL ENGINE TABLES CREATED IN PRODUCTION');
    console.log('='.repeat(80));
...
// Run the migration
createInternalGoalEngineTablesProduction();
